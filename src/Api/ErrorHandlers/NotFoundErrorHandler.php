...
/**
 * Class gérant le retour des Exceptions NotFoundException de Slim
 */
    ...
    public function __invoke(ServerRequestInterface $request, Throwable $exception, bool $displayErrorDetails, bool $logErrors, bool $logErrorDetails): ResponseInterface
    {
        if (!is_a($exception, HttpNotFoundException::class)) {
            throw new LogicException(
                "Appel de " . __METHOD__ . " pour une exception != de " . HttpNotFoundException::class
        ...
        $logger->warning("Route non trouvé pour : {$request->getUri()}");
